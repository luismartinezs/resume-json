export default [
  {
    ...
    title: "Senior Frontend Developer - Nuxt.js / Sanity Performance Specialist",
    company: "Toptal",
    ...
    responsibilities: [
      ...
      "Restructured the full Aeonik Pro font family into a subsetted woff+woff2 layout, added Anaheim with Latin, Latin-Ext, and Vietnamese subsets, and preloaded above-the-fold weights from the Sanity CDN.",
      "Configured Vercel edge caching for videos, PDFs, images, fonts, and captions with 7 to 30 day TTLs, eliminating cold-cache fetches for repeat visitors and cutting redundant origin transfer.",
      "Diagnosed and shipped a 4-commit Core Web Vitals fix (prerender/ISR conflict, browser cache headers, animation threshold, asset caching) that moved all 10 indexed URLs in Google Search Console from 'Needs improvement' to 'Good' within 48 hours.",
      "Built an HMAC-verified Sanity webhook to Vercel ISR revalidation route, cutting content publish-to-live propagation from up to 60 minutes down to 2-3 minutes and saving an estimated $40/month in ISR write costs.",
      "Sustained 100% production uptime since November 2025 and a Sentry performance score of 93 (7-day rolling) by January 2026 while running a 24/7 two-shift coverage rotation on an FDA-regulated pharma marketing site.",
    ],
    industries: ["Health & Nutrition Products"],
    skills: [
      "Nuxt.js",
      "Vue",
      "Sanity",
