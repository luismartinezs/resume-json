export default [
  ...
  },
  {
    ...
    description:
      "The Bulldozer Telegram bot is a multi-functional chatbot integrated with Telegram, OpenAI, Stripe, and Cloudflare. It handles user conversations, subscriptions, and invoicing, while also supporting advanced features like message debouncing, file handling, and reminders. It is deployed via Cloudflare Workers and connects to a SQLite database",
    skills: [
